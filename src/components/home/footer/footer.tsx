    ...
    <footer className="text-white max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
      ...
      <nav className="flex flex-wrap justify-center">
        <div className="px-5 py-2">
          <a href="#" className="text-base leading-6 text-white hover:text-primary">
            About
          </a>
        </div>
        <div className="px-5 py-2">
      ...
      <p className="mt-8 text-base leading-6 text-center text-gray-400">
        Developed with ❤️ by {" "}
        <a className="text-primary hover:underline" href="https://www.linkedin.com/in/kg1510/" target="_blank">
          Kushagra Gupta
        </a>
      </p>
    </footer>
